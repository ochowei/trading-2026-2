...
from trading_2026_2 import (
    tsm_mean_reversion_two_stage_volume_reversal_v023 as v023,
)
...
def test_close_equal_to_breakout_does_not_confirm_and_event_can_invalidate() -> None:
    ...
    equal_result = v023.backtest(equal_bars)
    ...
    invalidated_result = v023.backtest(invalidated_bars)
...
def test_original_path_lifecycle_matches_v009_when_supplemental_path_is_disabled() -> None:
    ...
    result = v023.backtest(
        bars, spec=v023.V009_ONLY_SPEC, cost=v023.BASE_COST
    )
