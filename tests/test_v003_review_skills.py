...
PACKAGE = REPOSITORY / "workflows/strategy-forward-replication-research--v003"
SKILLS = ["blind-review-strategy-study-v003", "study-development-note-authoring-v003"]
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "../elsewhere",
        "workflows/strategy-forward-replication-research--v003/studies/review-fixture/study.yml",
    ],
)
