"""TSM 量能加權收盤報酬一致性 v001 的 Development runner。
...
from trading_2026_2 import tsm_momentum_trend_volume_return_alignment_v001 as engine  # noqa: E402


CANDIDATE_ID = "tsm-momentum-trend-volume-return-alignment-v001"
BASELINE_ID = "tsm-momentum-trend-volume-return-alignment-baseline-v001"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="TSM 量能加權收盤報酬一致性 v001 Development runner")
