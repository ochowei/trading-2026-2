...
def test_release_package_is_reproducible_release_candidate(workflow_root) -> None:
    report = load_canonical(workflow_root / "release-test-report.yml")
    SchemaStore(workflow_root / "schemas").validate("release-test-report.schema.yml", report)
