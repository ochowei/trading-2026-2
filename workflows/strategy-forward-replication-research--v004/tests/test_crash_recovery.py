...
original_fixed_create = operation.create_if_same
...
def fixed_create(path, data):
    original_fixed_create(path, data)
    if (boundary == "authority-marker" and path.name == "evaluation-launch.yml") or (boundary == "marker" and path.name == "launch-marker.yml"):
        os._exit(71)
...
operation.create_if_same = fixed_create
