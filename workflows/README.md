...
詳細內容請參考 [`strategy-forward-replication-research--v003/README.md`](strategy-forward-replication-research--v003/README.md)。v003 已由 v004 取代，不再接受新的 Study；它仍保留自己的 rules、schemas、validator、writer、policies、tests、Study runtime 與正式 Release Record，供既有 Study 讀取與獨立驗證。

- [`release.yml`](strategy-forward-replication-research--v003/release.yml)：原始 Trusted Approver 建立的正式啟用紀錄，未被改寫。
- [`release-manifest.yml`](strategy-forward-replication-research--v003/release-manifest.yml)：v003 原有權威檔案與 SHA-256 數位指紋清單。
- [`release-test-report.yml`](strategy-forward-replication-research--v003/release-test-report.yml)：v003 原有發布前測試與完整性驗證報告。

## Strategy Forward Replication Research v002（Superseded）

詳細內容請參考 [`strategy-forward-replication-research--v002/README.md`](strategy-forward-replication-research--v002/README.md)。這個 Workflow Package 已由後繼版本取代，不再接受新的 Study；它仍保留自己的 rules、schemas、validator、writer、policies、tests 與原始 Release Record，供既有 Study 讀取與獨立驗證。
