...
v002 的實際建立與凍結前操作請先依 [操作指南](operations.md) 執行；以下說明研究階段與保留的語意。

本文件將 `strategy-forward-replication-research` 的研究流程縮減為最小可執行規格。詳細規則與
解釋請參考 [`strategy-forward-replication-research-v002-guide.md`](strategy-forward-replication-research-v002-guide.md)。
