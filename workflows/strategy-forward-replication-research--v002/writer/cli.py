...
def parser() -> argparse.ArgumentParser:
    result = argparse.ArgumentParser(description="strategy-forward-replication-research v002")
    ...
    create.add_argument("--prepare-report", type=Path, required=True)
    ...
    try:
        ...
        if args.command == "create":
            digest = service.create_study(
                ...
                prepare_report=load_canonical(args.prepare_report),
            )
            print(digest)
