"""TSM v024「上升趨勢放量蓄勢後短期突破」補充路徑研究引擎。
...
def backtest(
    ...
    *,
    ...
    """以單一 sleeve 執行 v009 原路徑加 v024 狀態化補充路徑。
    ...
    if spec.supplemental_confirmation_window != 5:
        raise ValueError("v024 supplemental confirmation window 必須固定為 5")
