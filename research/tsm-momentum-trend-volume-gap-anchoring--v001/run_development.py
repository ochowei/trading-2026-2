"""TSM v004 的 Development runner。

runner 只接受 Lifecycle 提供的 request，讀取 request 指定的固定 OHLCV，
並輸出單一 canonical YAML。Historical Evaluation 分支只為 v004 runner
...
from trading_2026_2 import tsm_momentum_trend_volume_gap_anchoring_v001 as engine  # noqa: E402

CANDIDATE_ID = "tsm-momentum-trend-volume-gap-anchoring-v001"
BASELINE_ID = "tsm-momentum-trend-volume-gap-anchoring-baseline-v001"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="TSM volume-gap Development runner")
