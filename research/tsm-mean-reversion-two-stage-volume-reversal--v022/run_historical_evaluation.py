"""TSM v022 Historical Evaluation runner 的凍結前相容實作。
    ...
    return {
        ...
        "supplemental_path": {
            "confirmation": {
                ...
                "last_post_event_session": spec.supplemental_confirmation_window,
                "trend_required": True,
            },
            ...
            "event": {
                ...
                "volume_ratio_minimum": _decimal_text(spec.supplemental_event_volume_ratio),
                "volume_ratio_operator": ">=",
            },
            "fixed_breakout_price": {
                "formula": "max(previous_five_session_high,event_day_high)",
                "previous_five_session_high_lookback": spec.supplemental_event_high_lookback,
            },
            "invalidation": {
            ...
            "observation": {
                ...
                "trend_sma_lookback": spec.sma_lookback,
                "trend_sma_lag_sessions": spec.supplemental_trend_sma_lookback,
...
def parser() -> argparse.ArgumentParser:
    result = argparse.ArgumentParser(description="產生 TSM v022 2020--2024 raw evidence")
