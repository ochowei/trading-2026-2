...
CANDIDATE_ID = "tsm-mr-two-stage-calibrated-volume-v008"
BASELINE_ID = "tsm-mean-reversion-two-stage-baseline-v008"
STUDY_ID = "tsm-mean-reversion-two-stage-volume-reversal--v008"
ENGINE_PATH = "src/trading_2026_2/tsm_mean_reversion_two_stage_volume_reversal_v008.py"
...
def parser() -> argparse.ArgumentParser:
    result = argparse.ArgumentParser(
        description="產生 TSM price-reversal time-decay v008 2014--2018 Development raw evidence"
    )
