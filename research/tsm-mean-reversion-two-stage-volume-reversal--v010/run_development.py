...
CANDIDATE_ID = "tsm-mr-two-stage-calibrated-volume-v010"
BASELINE_ID = "tsm-mean-reversion-two-stage-baseline-v010"
STUDY_ID = "tsm-mean-reversion-two-stage-volume-reversal--v010"
ENGINE_PATH = "src/trading_2026_2/tsm_mean_reversion_two_stage_volume_reversal_v010.py"
...
def parser() -> argparse.ArgumentParser:
    result = argparse.ArgumentParser(
        description="產生 TSM price-reversal time-decay v010 2014--2018 Development raw evidence"
    )
