"""產生 frozen TSM 兩階段止跌確認 v011 Historical Evaluation raw evidence。
...
def _engine_signal() -> dict[str, object]:
    ...
    return {
        ...
        "two_stage_confirmation": {
            "enabled": spec.delayed_confirmation,
            "qualification_valid_sessions": spec.qualification_valid_sessions,
