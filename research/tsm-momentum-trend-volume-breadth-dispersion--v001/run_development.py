"""TSM v004 breadth 加單日成交量占比上限 Development runner。
...
from trading_2026_2 import tsm_momentum_trend_volume_breadth_dispersion_v001 as engine  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="TSM volume-breadth Development runner")
