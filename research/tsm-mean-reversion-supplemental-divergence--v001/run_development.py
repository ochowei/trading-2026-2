...
CANDIDATE_ID = "tsm-mr-supplemental-divergence-v001"
BASELINE_ID = "tsm-mean-reversion-supplemental-divergence-baseline-v001"
STUDY_ID = "tsm-mean-reversion-supplemental-divergence--v001"
ENGINE_PATH = "src/trading_2026_2/tsm_mean_reversion_supplemental_divergence_v001.py"
...
def main() -> int:
    ...
    trade_items = [
        trade_record(
            ...
            base_trade,
            stress_trade,
            float(base_rates[index]),
            float(stress_rates[index]),
        )
