...
from trading_2026_2.tsm_mean_reversion_two_stage_volume_reversal_v001 import (
    BASE_COST,
    BASELINE_SPEC,
    DEFAULT_SPEC,
    STRESS_COST,
...
CANDIDATE_ID = "tsm-mr-two-stage-reversal-v001"
BASELINE_ID = "tsm-mean-reversion-two-stage-baseline-v001"
STUDY_ID = "tsm-mean-reversion-two-stage-volume-reversal--v001"
ENGINE_PATH = "src/trading_2026_2/tsm_mean_reversion_two_stage_volume_reversal_v001.py"
...
def parser() -> argparse.ArgumentParser:
    result = argparse.ArgumentParser(
        description="產生 TSM two-stage volume reversal v001 2014--2018 Development raw evidence"
    )
