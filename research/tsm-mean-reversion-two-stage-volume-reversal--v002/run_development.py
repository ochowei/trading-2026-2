...
BASELINE_ID = "tsm-mean-reversion-two-stage-baseline-v002"
STUDY_ID = "tsm-mean-reversion-two-stage-volume-reversal--v002"
ENGINE_PATH = "src/trading_2026_2/tsm_mean_reversion_two_stage_volume_reversal_v002.py"
...
def parser() -> argparse.ArgumentParser:
    result = argparse.ArgumentParser(
        description="產生 TSM two-stage volume reversal v002 2014--2018 Development raw evidence"
    )
