...
CANDIDATE_ID = "tsm-mr-two-stage-time-decay-v004"
BASELINE_ID = "tsm-mean-reversion-two-stage-baseline-v004"
STUDY_ID = "tsm-mean-reversion-two-stage-volume-reversal--v004"
ENGINE_PATH = "src/trading_2026_2/tsm_mean_reversion_two_stage_volume_reversal_v004.py"
...
def parser() -> argparse.ArgumentParser:
    result = argparse.ArgumentParser(
        description="產生 TSM two-stage volume reversal v004 2014--2018 Development raw evidence"
    )
