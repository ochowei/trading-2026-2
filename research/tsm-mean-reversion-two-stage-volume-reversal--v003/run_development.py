...
from trading_2026_2.tsm_mean_reversion_two_stage_volume_reversal_v003 import (
    BASE_COST,
    BASELINE_SPEC,
    DEFAULT_SPEC,
    STRESS_COST,
...
CANDIDATE_ID = "tsm-mr-two-stage-reversal-v003"
BASELINE_ID = "tsm-mean-reversion-two-stage-baseline-v003"
STUDY_ID = "tsm-mean-reversion-two-stage-volume-reversal--v003"
ENGINE_PATH = "src/trading_2026_2/tsm_mean_reversion_two_stage_volume_reversal_v003.py"
...
def parser() -> argparse.ArgumentParser:
    result = argparse.ArgumentParser(
        description="產生 TSM two-stage volume reversal v003 2014--2018 Development raw evidence"
    )
