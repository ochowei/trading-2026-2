"""產生 TSM v023 唯一一次 Development evidence。
...
from trading_2026_2 import tsm_mean_reversion_two_stage_volume_reversal_v023 as v023
from trading_2026_2.tsm_mean_reversion_two_stage_volume_reversal_v023 import (
    BASE_COST,
    BASELINE_SPEC,
    DEFAULT_SPEC,
    PRICE_ONLY_SPEC,
...
CANDIDATE_ID = "tsm-mr-two-stage-volume-reversal-uptrend-breakout-v023"
BASELINE_ID = "tsm-mean-reversion-two-stage-baseline-v009"
V009_ID = "tsm-mr-two-stage-calibrated-volume-v009"
STUDY_ID = "tsm-mean-reversion-two-stage-volume-reversal--v023"
ENGINE_PATH = "src/trading_2026_2/tsm_mean_reversion_two_stage_volume_reversal_v023.py"
...
def parser() -> argparse.ArgumentParser:
    result = argparse.ArgumentParser(description="產生 TSM v023 Development raw evidence")
...
def main() -> int:
    ...
    mechanism_ablation = {
        "v023_combined": _metric_summary(v023, bars, DEFAULT_SPEC, initial_cash),
        "v009_original_path_only": _metric_summary(v023, bars, V009_ONLY_SPEC, initial_cash),
        "v023_supplemental_only": _metric_summary(v023, bars, SUPPLEMENTAL_ONLY_SPEC, initial_cash),
        "v023_price_only": _metric_summary(v023, bars, PRICE_ONLY_SPEC, initial_cash),
        "simple_baseline": _metric_summary(v023, bars, BASELINE_SPEC, initial_cash),
