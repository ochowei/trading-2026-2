...
CANDIDATE_ID = "tsm-mr-selling-pressure-rollover-v001"
BASELINE_ID = "tsm-mr-selling-pressure-baseline-v001"
STUDY_ID = "tsm-mean-reversion-selling-pressure-rollover--v001"
...
def main() -> int:
    ...
    fixed_years = research_targets["evaluation_years"]["fixed_years"]
    fixed_years_pass = fixed_years == [2020, 2021, 2022, 2023, 2024]
    target_records.append(
        {
            "target": "evaluation_years",
            "actual": fixed_years,
            "operator": "equals",
            "required": fixed_years,
