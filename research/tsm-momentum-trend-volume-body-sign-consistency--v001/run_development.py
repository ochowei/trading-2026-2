"""TSM v004 量能非負實體占比 Development runner。
...
from trading_2026_2 import (  # noqa: E402
    tsm_momentum_trend_volume_body_sign_consistency_v001 as engine,
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="TSM volume-body-sign-consistency Development runner"
    )
