...
from trading_2026_2 import tsm_momentum_trend_volume_peak_lead_v001 as engine  # noqa: E402

CANDIDATE_ID = "tsm-momentum-trend-volume-peak-lead-v001"
BASELINE_ID = "tsm-momentum-trend-volume-peak-lead-v001-baseline"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="TSM volume-peak-lead Development runner")
...
def paired_trades(
    ...
    *,
    ...
    base_by_key = {item_key: item for item_key, item in ((lifecycle_key(t), t) for t in base.trades)}
    stress_by_key = {
        item_key: item for item_key, item in ((lifecycle_key(t), t) for t in stress.trades)
    }
...
def main() -> None:
    ...
    if request["stage"] == "historical-evaluation":
        value = historical_output(frame, preregistration=preregistration)
