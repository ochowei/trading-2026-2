"""TSM v004 成交量加權方向路徑效率 Development runner。
...
from trading_2026_2 import tsm_momentum_trend_volume_path_efficiency_v001 as engine  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="TSM volume path-efficiency Development runner")
