"""TSM v004 的量能先行後鈍化 Development runner。
...
if (REPOSITORY_ROOT / "workflow").is_dir():
    ...
    WORKFLOW_ROOT = (
        REPOSITORY_ROOT
        / "workflows"
        / "strategy-forward-replication-research--v004"
    )
...
from trading_2026_2 import tsm_momentum_trend_volume_fade_v001 as engine  # noqa: E402

CANDIDATE_ID = "tsm-momentum-trend-volume-fade-v001"
BASELINE_ID = "tsm-momentum-trend-volume-fade-v001-baseline"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="TSM volume-fade Development runner")
