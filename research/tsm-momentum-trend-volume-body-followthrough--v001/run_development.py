"""TSM v004 量先價後延遲報酬傳導 Development runner。
...
from trading_2026_2 import tsm_momentum_trend_volume_body_followthrough_v001 as engine  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="TSM volume-body-followthrough Development runner"
    )
