"""產生 frozen TSM 放量承接後縮量淺回測 v014 Historical Evaluation raw evidence。
...
from trading_2026_2.tsm_mean_reversion_two_stage_volume_reversal_v014 import (
    BASE_COST,
    DEFAULT_SPEC,
    STRESS_COST,
    backtest,
...
CANDIDATE_ID = "tsm-mr-two-stage-volume-reversal-retest-v014"
SYMBOL = "TSM"
...
def _engine_signal() -> dict[str, object]:
    ...
    return {
        ...
        "supplemental_retest": {
            "close_position_upper_half_inclusive": True,
            "event_expiry_after_sessions": spec.supplemental_event_window_max_sessions,
            "event_window_max_sessions_before_signal": spec.supplemental_event_window_max_sessions,
            "event_window_min_sessions_before_signal": spec.supplemental_event_window_min_sessions,
            "low_break_operator": "<",
            "low_must_not_break_event_low": True,
            "multiple_event_policy": "latest-valid-event-replaces-older-event",
            "pullback_volume_operator": "<=",
            "pullback_volume_ratio_to_event": _decimal_text(
                spec.supplemental_pullback_volume_ratio
            ),
            "signal_gap_lower_inclusive": _decimal_text(spec.supplemental_signal_gap_min),
            "signal_gap_upper_exclusive": _decimal_text(spec.supplemental_signal_gap_max),
            "signal_rsi_maximum": _decimal_text(spec.rsi_max),
            "single_use_event": True,
            "volume_event_ratio_to_prior_20_day_average": _decimal_text(
                spec.supplemental_volume_ratio
            ),
            "zero_range_event": "invalid",
        },
        "symbol": SYMBOL,
        "volume_leads_price": {
