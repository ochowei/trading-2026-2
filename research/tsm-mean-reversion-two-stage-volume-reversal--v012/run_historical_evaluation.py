"""產生 frozen TSM same-day intraday-reversal v012 Historical Evaluation raw evidence。
...
def _engine_signal() -> dict[str, object]:
    ...
    return {
        ...
        "price_direction_confirmation": {
            ...
            "intraday_reversal_confirmation": {
                "close_at_or_below_prior_close": True,
                "close_above_open": True,
                "close_location_fraction": "2/3",
                "close_location_operator": ">=",
                "enabled": True,
                "high_above_low": True,
                "operator": "OR",
            },
